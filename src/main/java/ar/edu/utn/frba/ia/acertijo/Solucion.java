	...
	public Individuo generarRandom(){
		...
		if(solucion.posibleSolucion[0].esHombre()){ //Si el primero en generarse es hombre, mantengo coherencia de sentar hombre-mujer
			for(int j=2; j<solucion.posibleSolucion.length; j=j+2){
				apellidosHombre = this.removerElemento(apellidosHombre, solucion.posibleSolucion[j-2].getApellido());
				nombresHombre = this.removerElemento(nombresHombre, solucion.posibleSolucion[j-2].getNombre());
				ocupaciones = this.removerElemento(ocupaciones, solucion.posibleSolucion[j-2].getOcupacion());
			...
			for(int i=3; i<solucion.posibleSolucion.length; i=i+2){
				...
				nombresMujer = this.removerElemento(nombresMujer, solucion.posibleSolucion[i-2].getNombre());
				ocupaciones = this.removerElemento(ocupaciones, solucion.posibleSolucion[i-2].getOcupacion());
		...
		if(solucion.posibleSolucion[0].esMujer()){ //Si el primero en generarse es mujer, mantengo coherencia de sentar mujer-hombre
			for(int j=2; j<solucion.posibleSolucion.length; j=j+2){
				apellidosMujer = this.removerElemento(apellidosMujer, solucion.posibleSolucion[j-2].getApellido());
				nombresMujer = this.removerElemento(nombresMujer, solucion.posibleSolucion[j-2].getNombre());
				ocupaciones = this.removerElemento(ocupaciones, solucion.posibleSolucion[j-2].getOcupacion());
			...
			for(int i=3; i<solucion.posibleSolucion.length; i=i+2){	
				...
				nombresHombre = this.removerElemento(nombresHombre, solucion.posibleSolucion[i-2].getNombre());
				ocupaciones = this.removerElemento(ocupaciones, solucion.posibleSolucion[i-2].getOcupacion());
